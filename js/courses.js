...
const COURSES = [
    ...
    },
    {
        ...
        description: 'Break the language barrier with our Spoken English course. Learn to express yourself clearly and confidently in any situation — workplace, class, or abroad. Classes focus on practical speaking with expert instructors who guide you every step of the way.',
        skills: ['Speaking', 'Listening', 'Pronunciation', 'Vocabulary'],
        features: [
            ...
            'Confidence Building Exercises', 'Air-Conditioned Classroom', 'Support Center Available',
    ...
    },
    {
        ...
        description: 'Master the building blocks of the English language. This course covers everything from basic grammar rules to advanced sentence structures, with a strong focus on practical writing skills you will use in academics and professional life.',
        skills: ['Grammar', 'Writing', 'Reading', 'Editing'],
        features: [
            'Parts of Speech & Sentence Structure', 'Tenses & Voice', 'Paragraph & Essay Writing',
            'Letter & Email Writing', 'Report Writing', 'Proofreading & Editing Skills',
