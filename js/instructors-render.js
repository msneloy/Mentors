...
(function() {
  ...
  */
  var renderInstructors;

  document.addEventListener('DOMContentLoaded', function() {
    var grid;
    grid = document.querySelector('.instructors-grid');
    if (grid) {
      return renderInstructors(grid);
    }
  });

  renderInstructors = function(container) {
    if (!(container && window.INSTRUCTORS)) {
      return;
    }
    return container.innerHTML = window.INSTRUCTORS.map(function(ins) {
