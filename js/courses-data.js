...
(function() {
  ...
  */
  window.COURSES = [
    ...
    "Speaking",
    "Exam Strategy"],
      features: ["Regular, Executive & Crash Course Options",
    ...
    "IELTS Support Centre at Multiple Locations (Mirpur, Uttara, Banani, Kalabagan, Wari)"],
      details: [
        {
          label: "Format",
          value: "Academic & General Training"
        },
        {
          label: "Duration",
    ...
    "Phonetics",
    "Conversation"],
      features: ["Basics of Speaking & Conversation Techniques",
    ...
    "Certificate on Completion"],
      details: [
        ...
        {
          label: "Classes",
          value: "3 days / week · 2 hours"
        },
        {
          label: "Bonus",
          value: "Language Club FREE · 2 Months"
        }
      ],
      phones: [
        {
    ...
    "Sentence Structure",
    "Vocabulary"],
      features: ["Nouns, Pronouns, Verbs, Articles, Adjectives",
    ...
    "Critical Thinking",
    "Editing"],
      features: ["Academic Essay Structures",
    ...
    "Pronunciation",
    "Presentation"],
      features: ["Reading & Writing Foundations",
    ...
    "Listening",
    "Exam Strategy"],
      features: ["Full Validity: 48 Hours - Perfect Scores Remain Valid",
    ...
    "Revision Sessions Included"],
      details: [
        ...
        {
          label: "Approved By",
          value: "3,000+ Universities & Colleges"
        }
      ],
      phones: [
        {
  ...
  window.COURSES_PAGE_CONTENT = {
    ...
    freeResources: {
      title: "Free <em>Resources</em>",
      description: "Access our exclusive collection of IELTS and spoken English materials.",
      ctas: [
        {
